#' Map of US Census Tracts in Tennessee
#' 
...
#'  
#' @seealso \link{tn.tract.regions}
#' @docType data
#' @name tn.tract.map
#' @usage data(tn.tract.map)
#' @references Taken from \url{https://www.census.gov/geo/maps-data/data/cbf/cbf_tracts.html}.
NULL

#' Metadata about the Tennessee Census Tracts map
#' 
...
#' 
#' @seealso \link{tn.tract.map}
#'  
#' @docType data
#' @name tn.tract.regions
#' @usage data(tn.tract.regions)
NULL

#'  A data.frame containing population estimates for Tennessee Census Tracts in 2012. 
#' 
#' @references Taken from the US American Community Survey (ACS) 5 year estimates.
#' @seealso \link{df_tn_tract_demographics}
#'  
#' @docType data
#' @name df_pop_tn_tract
#' @usage data(df_pop_tn_tract)
#' @examples
...
#' A data.frame containing demographic statistics for each Census Tract in Tennessee.
#'       
#' @name df_tn_tract_demographics
#' @docType data
#' @references Data comes from the 2013 5-year American Community Survey (ACS). Data generated by
#' ?get_tn_tract_demographics. 
#' @keywords data
#' @usage data(df_tn_tract_demographics)
#' @examples
#'  # 2013 per capita income estimate
#'  data(df_tn_tract_demographics)
#'  colnames(df_tn_tract_demographics)
#'  
